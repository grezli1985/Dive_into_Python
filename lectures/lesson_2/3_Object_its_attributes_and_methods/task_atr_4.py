...
# Документация по Python для «Hello world!» не найдена.
# Используйте help() для получения интерактивной справочной утилиты.
# Используйте help(str) для справки по классу str.
