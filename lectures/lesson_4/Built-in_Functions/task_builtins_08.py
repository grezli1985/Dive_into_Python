...
"""🔥 Важно! Все перечисленные выше функции имеют линейную асимптотику O(n), т.е. 
функция проходит последовательность от начала до конца прежде чем вернуть результат."""